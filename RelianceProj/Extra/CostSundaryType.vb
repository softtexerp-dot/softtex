        ...
        Try
            Using con As New SqlConnection(Module2.SqlServerConnectionString)
                ...
                With _strQuery
                    ...
                    .AppendLine(" AND Y_JOB_WORKER_STK_OWN = 'Cost Sheet Setting'")
                    .AppendLine(")")
                    ...
                    .AppendLine("VALUES")
                    .AppendLine("(@BEHAVIOUR, @BookName, @RCPT_ISSUE, @NATURE,")
                    .AppendLine(" @Y_OWN_STK, 0.00, 'Cost Sheet Setting', 0, 'YES')")
                End With

                Dim sql As String = _strQuery.ToString()
                Dim data As New List(Of Object()) From {
                                        New Object() {"0000-000000002", "YARN SUNDARY", "EXPENSES IN (%)", "ADD", "PER"},
                                        New Object() {"0000-000000003", "YARN SUNDARY", "INTEREST IN (%)", "ADD", "PER"},
                                        New Object() {"0000-000000004", "YARN SUNDARY", "WESTAGE IN (%)", "ADD", "PER"},
                                        New Object() {"0000-000000005", "WEAVING AND GREY COST", "RATE PER PICK", "ADD", "PER"},
                                        New Object() {"0000-000000006", "WEAVING AND GREY COST", "MENDING PER MTR", "ADD", "AMOUNT"},
...
#Region "Button Click"
    Private Sub UC_Buttons1_AddClick() Handles UC_Buttons1.AddClick
        ...
        txtSundaryType.Text = "YARN SUNDARY"
        txtAddless.Text = "ADD"
...
#Region "VIEW RECORD"
    Private Sub View_Record()
        Dim View_Filter_Condition = " AND A.Y_JOB_WORKER_STK_OWN='Cost Sheet Setting' "
