...
Public Class AppEntryManagement
    ...
    Private Sub LoadLRUpdateData(ByVal json As JObject)
        ...
        Try
            ...
            If json Is Nothing Then
                MessageBox.Show("API response empty hai.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If json("data") Is Nothing OrElse json("data").Type = JTokenType.Null Then
                MessageBox.Show("LR Update me data nahi mila.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            If arr Is Nothing Then
                MessageBox.Show("LR Update ka data valid JSON array nahi hai.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            ...
            If dtAcc Is Nothing Then
                Throw New Exception("MstMasterAccount ka DataTable Nothing return kar raha hai.")
            End If
            ...
            If dtTransport Is Nothing Then
                Throw New Exception("MSTTRANSPORT ka DataTable Nothing return kar raha hai.")
            End If
            ...
            If dtCity Is Nothing Then
                Throw New Exception("MSTCITY ka DataTable Nothing return kar raha hai.")
            End If
            ...
            If GridControl1 Is Nothing Then
                Throw New Exception("GridControl1 Nothing hai.")
            End If
            GridControl1.DataSource = Nothing
            FirstStage.Columns.Clear()
            GridControl1.DataSource = LRdtSource.Copy
            If FirstStage Is Nothing Then
                Throw New Exception("GridControl1.MainView GridView nahi hai.")
            End If
        ...
        Catch ex As Exception
            MessageBox.Show("LR Update data load karte samay error aaya." & vbCrLf & vbCrLf & "Details: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub LRViewImage_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
        Try
            ...
            If String.IsNullOrWhiteSpace(imageUrl) Then
                MessageBox.Show("Is entry ke liye image available nahi hai.", "Image", MessageBoxButtons.OK,
        ...
        Catch ex As Exception
            MessageBox.Show("Image load karte samay error aaya." & vbCrLf & vbCrLf & ex.Message, "Image Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub LoadOffersAndInvoiceData(ByVal json As JObject)
        Try
            Dim arr As JArray = CType(json("data"), JArray)
            ...
            For Each r As JObject In arr
                ...
                dr("TaxPercentage") =
                FormatDecimal(r("TaxPercentage").ToString())

                dr("TaxAmount") =
                FormatDecimal(r("TaxAmount").ToString())

                dr("DiscountPercentage") =
                FormatDecimal(r("DiscountPercentage").ToString())

                dr("DiscountAmount") =
                FormatDecimal(r("DiscountAmount").ToString())
            ...
            AddHandler FirstStage.RowCellStyle, AddressOf GridView1_RowCellStyle
        Catch ex As Exception
            MessageBox.Show("Offers/Invoice data load karte samay error aaya." & vbCrLf & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
