...
#End Region
    ...
    Private Sub _EditLog(ByVal _EntryType As String)
        Dim BookType As String = "Gate Inward"
        Dim _Item As String = ""
        Dim _Rate As String = ""
        Dim _qty As String = ""
...
#Region "Attachment 2"
    ...
    Private Sub BtnView2_Click(sender As Object, e As EventArgs) Handles BtnView2.Click
        ...
        Dim hasValidPath As Boolean = Not String.IsNullOrWhiteSpace(txtFilePath2.Text)

        If hasValidPath AndAlso My.Computer.Network.IsAvailable Then
            _ImageView_Click(txtFilePath2.Text.Trim(), flagstring, _FORMMODE)
        Else
            _ImageView_Click(txtFilePath2.Text.Trim())
        End If
    End Sub
#End Region
End Class