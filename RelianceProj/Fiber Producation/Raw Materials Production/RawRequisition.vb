...
#Region "Form Load"
    ...
    Private Sub SamplerRateContract_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtBookCode.Text = "0001-000010012"
        _BookTrType = "RAW02"
...
#Region "VIEW RECORD "
    ...
    Private Sub btn_View_Print_Click(sender As Object, e As EventArgs)
        Dim _RptTiltle = "Raw Requisition Report From :" & txt_From.Text & " To : " & txt_To.Text
...
#Region "DATE RANGE CHECK"
    ...
    Private Sub BtnRPTPrint_Click(sender As Object, e As EventArgs) Handles BtnRPTPrint.Click
        ...
        If dtTmp.Rows.Count > 0 Then
            ...
            REPORT_RPT_FILE_NAME = "RawRequisitionReport"
