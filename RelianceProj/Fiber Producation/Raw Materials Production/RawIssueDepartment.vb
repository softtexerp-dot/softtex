...
Public Class RawIssueDepartment
...
#Region "Form Load"
    Private Sub Packing_JobCard_Closed(sender As Object, e As EventArgs) Handles MyBase.Closed
    ...
    Private Sub SamplerRateContract_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtBookCode.Text = "0001-000010013"
        _BookTrType = "RAW03"
    ...
    Private Sub Fabric_Rate_Contract_Entry_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
#Region "VIEW RECORD "
    ...
    Private Sub btn_View_Print_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        Dim _RptTiltle = "Raw Issue To Machine Report From :" & txt_From.Text & " To : " & txt_To.Text
...
#Region "GRID ITEM EVENTS "
    ...
    Private Sub grditem_KeyDown(ByVal Sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles GrdItem.KeyDown
        ...
        ElseIf _ActivatedColName = "OP6" Then
            If e.KeyCode = Keys.Enter AndAlso GrdItem.Cell(GrdItem.ActiveCell.Row, _DataTableGrid.Columns.IndexOf("USEBY") + 1).Text <> "YES" And Val(GrdItem.Cell(GrdItem.ActiveCell.Row, _DataTableGrid.Columns.IndexOf("MTR_WEIGHT") + 1).Text) = 0 Then
                ...
                Dim _Filterstring As String = " And A.Bookcode = '0001-000010012' and A.GodownCode='" & txtUnitCode.Text & "' And A.OP8='YES'"
                Dim _Filterstring_B As String = " And A.Bookcode = '0001-000010013' and A.GodownCode='" & txtUnitCode.Text & "'"
                ...
                If selected IsNot Nothing Then
                    ...
                    For i As Integer = 1 To GrdItem.Rows - 1
                        ...
                        'Dim StockID As String = GrdItem.Cell(i, _DataTableGrid.Columns.IndexOf("OP24") + 1).Text.Trim()
                        Dim BrandCode As String = GrdItem.Cell(i, _DataTableGrid.Columns.IndexOf("SHADECODE") + 1).Text
                        Dim cutcode As String = GrdItem.Cell(i, _DataTableGrid.Columns.IndexOf("CUTCODE") + 1).Text
                        Dim departmentcode As String = GrdItem.Cell(i, _DataTableGrid.Columns.IndexOf("DESIGNCODE") + 1).Text
                        ...
                        If ItemCode <> "" AndAlso BrandCode <> "" AndAlso cutcode <> "" AndAlso departmentcode <> "" Then
                            ...
                            Dim Key As String = ItemCode & "|" & AccountCode & "|" & BrandCode & "|" & cutcode & "|" & departmentcode
                            Dim Qty As Double = Val(GrdItem.Cell(i, _DataTableGrid.Columns.IndexOf("MTR_WEIGHT") + 1).Text)
                    ...
                    For Each dr As DataRow In _opningstkTmptbl.Rows
                        ...
                        Dim cutcode As String = dr("CountCode").ToString().Trim()
                        Dim departmentcode As String = dr("CITYCODE").ToString().Trim()
                        'Dim StockID As String = dr("ID").ToString().Trim()
        ...
        ElseIf _ActivatedColName = "MTR_WEIGHT" Then
            If e.KeyCode = Keys.Enter Then
                ...
                If EnterQty > ReqQty AndAlso ReqQty > 0 Then
                    ...
                    Exit Sub
                End If
                If EnterQty > stockQty AndAlso stockQty > 0 Then
        ...
        End If
    End Sub
    Public Function _GetPendingReq(ByVal _FilterStrng As String, ByVal _FilterStrng_B As String)
        ...
        With _StrOpenQuery
            ...
            .Append(" WHERE A.Bookcode in ('0001-000010011','0001-000010019') ")
            .Append(_FilterStrng)
            .Append(" UNION ALL ")
            .Append(" SELECT ")
        ...
        Dim _GetQuey As String = _StrOpenQuery.ToString
    ...
    Public Function _GetPendingStock(ByVal _FilterStrng As String, ByVal _Filterstring_B As String)
        ...
        Dim _GetQuey As String = _StrQuery.ToString
