...
Public Class RawPurchaseReturn
...
#Region "Form Load"
    ...
    Private Sub SamplerRateContract_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtBookCode.Text = "0001-000010018"
        _BookTrType = "RAW08"
        ...
        ElseIf _ActivatedColName = "ACCOUNTNAME" Then
            If e.KeyCode = Keys.Enter AndAlso Val(GrdItem.Cell(GrdItem.ActiveCell.Row, _DataTableGrid.Columns.IndexOf("MTR_WEIGHT") + 1).Text) = 0 Then
                ...
                With _StrQuery
                    ...
                    .Append(" WHERE 1=1 ")
                    .Append(" AND A.Bookcode = '0001-000010017'")
...
#Region "DATE RANGE CHECK"
    ...
    Private Sub BtnRPTPrint_Click(sender As Object, e As EventArgs) Handles BtnRPTPrint.Click
        ...
        If dtTmp.Rows.Count > 0 Then
            ...
            Next
            Dim RptTitle = "Raw Purchase Return Report"
            Dim Date_Range = CDate(Date.Now).ToString("dd/MM/yyyy") & " To " & Date.Now.ToString("dd/MM/yyyy")
            REPORT_RPT_FILE_NAME = "RawPurchaseReturnReport"
