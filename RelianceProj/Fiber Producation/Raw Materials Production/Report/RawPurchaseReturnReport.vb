...
Public Class RawPurchaseReturnReport
    ...
    Private Sub View_Log_Book()
        Try
            ...
            With _strQuery
                ...
                .Append(" WHERE A.BOOKCODE In ('0001-000010011','0001-000010019','0001-000010022') ")
                .Append(" UNION ALL ")
                .Append(" SELECT ")
                .Append(" A.PACK_SLIP_DATE, ")
                .Append(" A.ACCOUNTCODE, ")
            ...
            If Tmp_Data_Table.Rows.Count > 0 Then
                Dim RptTitle = "Raw Materials Entry Report :" & txt_From.Text & " TO " & txt_To.Text
                Dim Date_Range = ""
                If But_ok.Enabled = True Then
                    If txt_From.Text <> "" AndAlso txt_From.Text <> "" Then
                        REPORT_RPT_FILE_NAME = "RawPurchaseReturnStockReport_1"
