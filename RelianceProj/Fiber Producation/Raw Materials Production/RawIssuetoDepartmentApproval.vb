...
Public Class RawIssuetoDepartmentApproval
    ...
    Private Sub View_Record()
        ...
        With _UserQuery
            ...
            .Append(TypeFilter)
            '====================================================
            ' HIDE ROW WHEN REQUEST / ISSUE / BALANCE ALL ZERO
            '====================================================
            .Append(" AND ( ")
