...
Public Class VendorMasterPrint
    ...
    Private Sub CheckMaxEntry()
        ...
        View_Filter_Condition = " and a.Group_master_finance='VENDOR MASTER'  "
    ...
    Private Sub View_Log_Book()
        Try
            ...
            If Txt_FromEntryNo.Text <> "" AndAlso Txt_ToEntryNo.Text <> "" Then
                View_Filter_Condition = "AND A.MAIN_ACCOUNT_MASTER>='" & Txt_FromEntryNo.Text & "' and A.MAIN_ACCOUNT_MASTER<='" & Txt_ToEntryNo.Text & "' and a.Group_master_finance='VENDOR MASTER' "
            End If
            _strQuery = New StringBuilder()
            With _strQuery
                .Append(" SELECT  ")
            ...
            If Tmp_Data_Table.Rows.Count > 0 Then
                ...
                Dim RptTitle = "Vendor Master Report"
                Dim Date_Range = ""
                If But_ok.Enabled = True Then
                    If Txt_FromEntryNo.Text <> "" AndAlso Txt_ToEntryNo.Text <> "" Then
                        REPORT_RPT_FILE_NAME = "VendorMasterReport_" & Ctl_RptType.Text & ""
    ...
    Private Sub _ButtonFocus()
        If _Selectionbutton = "Vendor No" Then
            BtnItem.Focus()
        End If
