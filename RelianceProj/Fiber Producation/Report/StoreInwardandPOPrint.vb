...
Public Class StoreInwardandPOPrint
    ...
    Private Sub CheckMaxEntry()
        ...
        View_Filter_Condition = " and a.BookTrtype='IPSS1' and A.godowncode='" & _GodownCode & "' "
    ...
    Private Sub View_Log_Book()
        Try
            ...
            If Txt_FromEntryNo.Text <> "" AndAlso Txt_ToEntryNo.Text <> "" Then
                View_Filter_Condition = "AND A.EntryNo>='" & Txt_FromEntryNo.Text & "' and A.EntryNo<='" & Txt_ToEntryNo.Text & "' and a.BookTrtype='IPSS1' And A.godowncode='" & _GodownCode & "'  "
            End If
            _strQuery = New StringBuilder()
            With _strQuery
                .Append(" SELECT ")
            ...
            If Tmp_Data_Table.Rows.Count > 0 Then
                ...
                If But_ok.Enabled = True Then
                    If Txt_FromEntryNo.Text <> "" AndAlso Txt_ToEntryNo.Text <> "" Then
                        REPORT_RPT_FILE_NAME = "StoreInwardandPOReport_" & Ctl_RptType.Text & ""
