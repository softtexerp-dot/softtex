...
#Region "Form Load"
    ...
    Private Sub SamplerRateContract_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtBookCode.Text = "0001-000010026"
        _BookTrType = "PET13"
...
#End Region
    ...
    Private Sub _EditLog(ByVal _EntryType As String)
        Dim BookType As String = "Store Westage Entry"
        Dim _Item As String = ""
        Dim _Rate As String = ""
        Dim _qty As String = ""
...
#Region "VIEW RECORD "
    ...
    Private Sub View_Record()
        ...
        With strQuery
            ...
            .Append("  A.PACK_SLIP_NO as [Westage No], ")
        ...
        If tblTmp.Rows.Count > 0 Then
            ...
            FirstStage.Columns("Westage No").AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
            FirstStage.Columns("Westage No").AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
    ...
    Private Sub btn_View_Print_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        Dim _RptTiltle = "Pet Westage Entry Report From :" & txt_From.Text & " To : " & txt_To.Text
