    ...
    Private Sub View_Record()
        Try
            ...
            With _UserQuery
                ...
                .Append("  Left Join ( SELECT  OP19 AS TrueStatus,BOOKVNO  FROM TrnPackingSlip  WHERE OP19='YES' AND  BookTrType='PET06' AND GodownCode='" & txtUnitCode.Text.Trim & "' GROUP BY OP19,BOOKVNO ) AS J ON ( A.BOOKVNO= J.BOOKVNO ) ")
                .Append(" Left Join ( ")
                ...
                .Append(" WHERE 1=1  ")
                .Append(" And A.BOOKCODE='0001-000010006'  ")
