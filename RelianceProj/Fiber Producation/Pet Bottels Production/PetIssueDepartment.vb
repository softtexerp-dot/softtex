...
Public Class PetIssueDepartment
...
#Region "GRID ITEM EVENTS "
    ...
    Private Sub grditem_KeyDown(ByVal Sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles GrdItem.KeyDown
        ...
        ElseIf _ActivatedColName = "OP6" Then
            If e.KeyCode = Keys.Enter AndAlso GrdItem.Cell(GrdItem.ActiveCell.Row, _DataTableGrid.Columns.IndexOf("USEBY") + 1).Text <> "YES" And Val(GrdItem.Cell(GrdItem.ActiveCell.Row, _DataTableGrid.Columns.IndexOf("MTR_WEIGHT") + 1).Text) = 0 Then
                ...
                Dim _Filterstring As String = " And A.Bookcode = '0001-000010002' and A.GodownCode='" & txtUnitCode.Text & "' And A.OP8='YES'"
    ...
    Public Function _GetPendingReq(ByVal _FilterStrng As String, ByVal _FilterStrng_B As String)
        ...
        With _StrOpenQuery
            ...
            .Append(" WHERE A.Bookcode in ('0001-000010001','0001-000010009') ")
            .Append(_FilterStrng)
            .Append(" UNION ALL ")
            .Append(" SELECT ")
            ...
            .Append(" A.SHADECODE ")
            .Append(" FROM TrnPackingSlip AS A ")
            .Append(" WHERE A.Bookcode in ('0001-000010003','0001-000010026') ")
